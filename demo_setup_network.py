...
print(reaction_df)
collector.store_network(network_id = 1, reaction_df=reaction_df, network_name='Legewie Wildtype')
# collector.store_rate_set(network_id = 1, rate_set_id = 1, rate_df)
# collector.store_ivp(network_id = 1, rate_set_id = 1, initial_value_df)
